...
class MrClay_CookieStorage {
    ...
    public function getDefaults()
    {
        return array(
            ...
            ,'hashFunc' => array('\StartupAPI\MrClay_CookieStorage', 'hash')
            ,'encryptFunc' => array('\StartupAPI\MrClay_CookieStorage', 'encrypt')
            ,'decryptFunc' => array('\StartupAPI\MrClay_CookieStorage', 'decrypt')
