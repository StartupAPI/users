 ...
 */
class LinkedInAuthenticationModule extends \StartupAPI\OAuthAuthenticationModule {

	protected $userCredentialsClass = '\StartupAPI\Modules\LinkedInAuthenticationModule\LinkedInUserCredentials';
	...
	public function __construct($oAuthConsumerKey, $oAuthConsumerSecret, $oAuthScope = null) {
		parent::__construct(
			...
			$oAuthScope,
			\StartupAPI\UserConfig::$USERSROOTURL . '/modules/linkedin/linkedin-small.png',
			\StartupAPI\UserConfig::$USERSROOTURL . '/modules/linkedin/linkedin-small.png',
			\StartupAPI\UserConfig::$USERSROOTURL . '/modules/linkedin/linkedin-small.png'
		);
	}
	...
	public static function getModulesLogo($size = 100) {
		if ($size == 100) {
			return \StartupAPI\UserConfig::$USERSROOTURL . '/modules/linkedin/images/logo_100x.png';
		}
	}

	public function getIdentity($oauth_user_id) {
		$request = new \OAuthRequester(
			'http://api.linkedin.com/v1/people/~:(id,formatted-name,picture-url,public-profile-url)?format=json',
			'GET'
		);
	...
	protected function renderUserInfo($serialized_userinfo) {
		...
		return \StartupAPI\StartupAPI::$template->render("@startupapi/modules/linkedin/user_info.html.twig", $template_info);
	}
