 ...
 */
class GoogleOAuthAuthenticationModule extends \StartupAPI\OAuthAuthenticationModule {

	protected $userCredentialsClass = '\StartupAPI\Modules\GoogleOAuthAuthenticationModule\GoogleOAuthUserCredentials';
	...
	public function __construct($oAuthConsumerKey, $oAuthConsumerSecret, $GoogleAPIScopes = null) {
		...
		parent::__construct(
			...
			array('HMAC-SHA1'),
			implode(' ', $scopes),
			\StartupAPI\UserConfig::$USERSROOTURL . '/modules/google_oauth/login-button.png',
			\StartupAPI\UserConfig::$USERSROOTURL . '/modules/google_oauth/login-button.png',
			\StartupAPI\UserConfig::$USERSROOTURL . '/modules/google_oauth/login-button.png',
			array(
