 ...
 */
class TwitterAuthenticationModule extends \StartupAPI\OAuthAuthenticationModule {
	protected $userCredentialsClass = '\StartupAPI\Modules\TwitterAuthenticationModule\TwitterUserCredentials';
	...
	public function __construct($oAuthConsumerKey, $oAuthConsumerSecret)
	{
		parent::__construct(
			...
			array('HMAC-SHA1'),
			'http://api.twitter.com',
			\StartupAPI\UserConfig::$USERSROOTURL.'/modules/twitter/login-button.png',
			\StartupAPI\UserConfig::$USERSROOTURL.'/modules/twitter/login-button.png',
			\StartupAPI\UserConfig::$USERSROOTURL.'/modules/twitter/login-button.png',
			array(
	...
	public static function getModulesLogo($size = 100) {
		if ($size == 100) {
			return \StartupAPI\UserConfig::$USERSROOTURL . '/modules/twitter/images/logo_100x.png';
		}
	}
	...
	protected function renderUserInfo($serialized_userinfo) {
		...
		return \StartupAPI\StartupAPI::$template->render(
			"@startupapi/modules/twitter/user_info.html.twig",
			$template_info
		);
	}
}
