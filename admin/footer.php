...
?><!-- admin footer starts -->
		...
		<footer class="footer startupapi-admin-footer navbar-inner">
			<div class="container">
				...
				<p>Powered by <a href="http://www.startupapi.com/" target="_blank">Startup API v<?php echo StartupAPI::getVersion() ?></a>. Code licensed under the <a href="https://github.com/StartupAPI/users/blob/master/LICENSE-MIT" target="_blank">MIT License</a>.</p>
